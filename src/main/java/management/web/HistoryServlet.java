...
import management.model.User;
	...
	@WebServlet(urlPatterns = {"/history","/history_insert","/historylist"})
	public class HistoryServlet extends HttpServlet {
		...
		private void listHistory(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException, SQLException{
			List <History> listHistory = historyDAO.selectAllHistory();
			request.setAttribute("listHistory", listHistory);
